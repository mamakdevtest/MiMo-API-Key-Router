      ...
      while (true) {
        ...
        for (const model of response.models) {
          ...
          const payload = {
            ...
            supportsChat: detail?.supportsChat ?? (model.supportsChat as boolean | undefined) ?? true,
            supportsTextCompletion: detail?.supportsTextCompletion ?? (model.supportsTextCompletion as boolean | undefined) ?? false,
            supportsTools: detail?.supportsTools ?? (model.supportsTools as boolean | undefined) ?? false,
            supportsVision: detail?.supportsVision ?? (model.supportsVision as boolean | undefined) ?? false,
            supportsEmbeddings: detail?.supportsEmbeddings ?? (model.supportsEmbeddings as boolean | undefined) ?? false,
